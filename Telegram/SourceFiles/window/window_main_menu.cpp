...
, _version(this, st::mainMenuVersionLabel) {
	...
	_version->setRichText(textcmdLink(1, lng_settings_current_version(lt_version, currentVersionText())) + QChar(' ') + QChar('M') + QChar('y')+ QChar(' ')+ QChar(8211) + QChar(' ') + textcmdLink(2, lang(lng_menu_about)));
